                        ...
                        <div className="rightToLeft">
                            {
                                [0, 1, 2, 3, 4, 5, 6, 7].map((value2) => (
                                    <div onClick={(e) => stpont(value1, value2, e, 1)} className="box" id={`${value1}${value2}`} style={
                                        (value1 % 2) === (value2 % 2) ? { background: 'white' } : { background: '#9fe89f' }
                                    }>
                                        {arr[value1][value2] ?
                                            <img src={arr[value1][value2]} alt="shonno" /> : null}
